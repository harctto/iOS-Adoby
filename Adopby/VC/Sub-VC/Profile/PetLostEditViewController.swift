...
class PetLostEditViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    func setupDropdown() {
        ...
        ddStatus.dataSource = ["กำลังตามหา","เจอแล้ว"]
        //
