...
public struct UIKitSettings {
    ...
    // style
    static var primaryColor: UIColor = #colorLiteral(red: 0.4941176471, green: 0.3960784314, blue: 0.07843137255, alpha: 1)
    ...
    static var groups: SwitchMode = .disabled
    ...
    static var passwordGroup: SwitchMode = .disabled
    ...
    static var userVideoCall: SwitchMode = .disabled
    static var userAudioCall: SwitchMode = .disabled
    static var groupAudioCall: SwitchMode = .disabled
    static var groupVideoCall: SwitchMode = .disabled
    static var groupCreation: SwitchMode = .disabled
    static var joinOrLeaveGroup: SwitchMode = .disabled
    static var viewGroupMembers: SwitchMode = .disabled
    static var allowDeleteGroup: SwitchMode = .disabled
    ...
    static var shareLocation: SwitchMode = .disabled
