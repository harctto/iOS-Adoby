...
class CometChatConversationListItem: UITableViewCell {
    ...
    let normalTitlefont = UIFont.init(name: "Prompt-Medium", size: 17)
    let boldTitlefont = UIFont.init(name: "Prompt-Bold", size: 17)
    let normalSubtitlefont = UIFont.init(name: "Prompt-Regular", size: 15)
    let boldSubtitlefont = UIFont.init(name: "Prompt-Regular", size: 15)
