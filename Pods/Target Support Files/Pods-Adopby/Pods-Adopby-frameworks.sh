...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CometChatPro/CometChatPro.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CometChatPro/Starscream.framework"
fi
