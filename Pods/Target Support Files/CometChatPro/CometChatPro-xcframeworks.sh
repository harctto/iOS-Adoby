...
install_xcframework "${PODS_ROOT}/CometChatPro/Vendors/CometChatPro.xcframework" "CometChatPro" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/CometChatPro/Vendors/Starscream.xcframework" "CometChatPro" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
